...
public class StatisticsSingleton {
	...
	private long mLongestIgnoreTimeMillis;
	...
	public void updateStatisticsHelper(Context context) {
		...
		mLongestIgnoreTimeMillis = DatabaseUtility.longestIgnoreValue(context);
	...
	public static long getLongestIgnoreTime() {
		return getStatisticsSingleton().mLongestIgnoreTimeMillis;
	}
}
